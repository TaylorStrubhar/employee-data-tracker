...
const addEmp = async () => {
    try {
        const [roles, employees] = await Promise.all([employeeData.getRoles(), employeeData.getEmp()]);
        ...
        await employeeData.createEmployee(newEmp);
...
const addDept = async () => {
    try {
        ...
        await employeeData.createDept(newDept);
...
const addRole = async () => {
    try {
        const departments = await employeeData.getDepts();
        ...
        await employeeData.createRole(newRole);
